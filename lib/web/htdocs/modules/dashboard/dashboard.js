                    ...
                    if (typeof list_value === 'object' ) {
                        $.each(list_value, function(key2, tuner_status) {
                            if (typeof tuner_status === 'object' ) {
                                $('#tuners').append('<tr><td>' + tuner_status.status +'</td><td>' + key1 + '</td><td>tuner' + key2 + '</td><td>' + tuner_status.instance + '</td><td>' + tuner_status.ch + '</td><td>' + (tuner_status.mux === null ? 1 : tuner_status.mux) + '</td></tr>');
                                active = true;
